...
;
const metadata = {
    title: "AI Shipping Copilot - All-in quotes, live tracking, and duty/VAT explainers",
    description: "Get instant shipping quotes with full cost breakdowns, track packages in real-time, and understand duties and VAT charges - all in one place.",
    keywords: "shipping calculator, package tracking, shipping quotes, duties VAT calculator, international shipping"
};
